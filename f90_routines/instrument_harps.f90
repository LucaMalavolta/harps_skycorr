module instrument_harps
  ...
  character (len=*), parameter :: archive_raw = archive_raw_harps
  character (len=*), parameter :: archive_red = archive_red_harps

  ! fits images informations (HARPS)
  integer, parameter :: n_order = 72, n_pix = 4096

  integer, parameter :: starting_order = 2
...
!!! ADC variables:
  ...
  character (len=*), parameter :: sun_continuum = trim(tables_path) // 'HARPS_Ganymede_norm_poly.fits'
