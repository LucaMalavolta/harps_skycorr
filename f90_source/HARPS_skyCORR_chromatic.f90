...
if  (iargc() .lt. 3) then
    ...
    write(*,*) ' 5) optional: use wave_A for fiber B as well, T o F allowed (default: F)'
...
do ii=1,x_ccf
    ccf_S(ii,y_ccf) = sum(ccf_S(ii,starting_order:y_e2ds),dim=1)
end do
